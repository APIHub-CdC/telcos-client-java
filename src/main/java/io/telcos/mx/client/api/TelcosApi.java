...
import io.telcos.mx.client.ApiResponse;
import io.telcos.mx.client.Configuration;
import io.telcos.mx.client.Pair;
import io.telcos.mx.client.ProgressRequestBody;
import io.telcos.mx.client.ProgressResponseBody;
...
public class TelcosApi {
    ...
    public ApiResponse<?> getReporteGeneric(String xApiKey, String username, String password, Peticion body) throws ApiException {
