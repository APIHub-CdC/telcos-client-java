...
public class PersonaRespuesta {
  ...
  @ApiModelProperty(example = "ROBERTO MIGUEL", required = true, value = "Primer nombre de la persona")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(nombres, apellidoPaterno, apellidoMaterno, apellidoAdicional, fechaNacimiento, RFC, CURP, numeroSeguridadSocial, nacionalidad, residencia, estadoCivil, sexo, claveElectorIFE, numeroDependientes, fechaDefuncion);
  }
  @Override
